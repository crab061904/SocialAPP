...
const addCommentToPost = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
const deleteComment = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    if (comment.parentModel === 'Post') {
      ...
      reel.comments = reel.comments.filter((commentId) => commentId.toString() !== comment._id.toString());
      await reel.save();
    }
...
const getCommentsForPost = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
const getCommentsForReel = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
